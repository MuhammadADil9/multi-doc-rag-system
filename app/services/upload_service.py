...
def process_upload(
    ...
    try:
        ...
        # STEP 1: Validate PDF
        print("\n[1/7] Validating PDF...")
        PDFParser.validate_file(pdf_file=file_path, max_size=settings.MAX_PDF_SIZE)

        # STEP 2: Extract Text
        print("\n[2/7] Extracting text...")
        text = PDFParser.extract_text(pdf_path=file_path)
        ...
        metadatas = [
            {"chunk_id": chunk_id, "document_id": str(document_id), "chunk_index": idx}
